...
class ''' + list_names[i] + '''Service:
    ...
    @staticmethod
    def update(''' + class_names[i].lower() + ''': ''' + class_names[i] + ''', ''' + class_names[
        i].lower() + '''_change_updates: ''' + class_names[i] + '''Interface) -> ''' + class_names[i] + ''':
    ...
    def delete_by_id(''' + class_names[i].lower() + '''_id: int) -> List[int]:
        ''' + class_names[i].lower() + ''' = ''' + class_names[i] + '''.query.filter(''' + class_names[i] + '''.''' + \
           id_names[i] + ''' == ''' + class_names[i].lower() + '''_id).first()
