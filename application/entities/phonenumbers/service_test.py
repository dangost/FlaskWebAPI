...
def test_get_all(db: SQLAlchemy):  # noqa
    yin: PhoneNumber = PhoneNumber(PhoneNumberId=16, PeoplePersonId=16, LocationLocationId=16, PhoneNumber=16,
                                   CountryCode=16, PhoneType=16)
    yang: PhoneNumber = PhoneNumber(PhoneNumberId=16, PeoplePersonId=16, LocationLocationId=16, PhoneNumber=16,
                                    CountryCode=16, PhoneType=16)
    db.session.add(yin)
    db.session.add(yang)
    db.session.commit()
