...
def test_get_all(db: SQLAlchemy):  # noqa
    yin: Country = Country(CountryId=16, CountryName="test16", CountryCode="test16", NatLangCode=16, CurrencyCode="test16")
    yang: Country = Country(CountryId=16, CountryName="test16", CountryCode="test16", NatLangCode=16, CurrencyCode="test16")
    db.session.add(yin)
    db.session.add(yang)
    db.session.commit()
