...
@fixture
def product() -> Product:
    return Product(ProductId=1, ProductName="test", Description="test", Category=1, WeightClass="test",
                   WarrantyPeriod=1, SupplierId=1, Status="test", ListPrice=1, MinimumPrice=1, PriceCurrency="test",
                   CatalogURL="test")
