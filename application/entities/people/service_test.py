...
def test_get_all(db: SQLAlchemy):  # noqa
    yin: Person = Person(PersonId=16, FirstName="test16", LastName="test16", MiddleName="test16", Nickname="test16",
                         NatLangCode=16, CultureCode=16, Gender="test16")
    yang: Person = Person(PersonId=16, FirstName="test16", LastName="test16", MiddleName="test16", Nickname="test16",
                          NatLangCode=16, CultureCode=16, Gender="test16")
    db.session.add(yin)
    db.session.add(yang)
    db.session.commit()
