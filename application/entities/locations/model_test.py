...
def location() -> Location:
    return Location(LocationId=1, CountryId=1, AddressLine1="test", AddressLine2="test", City="test", State="test",
                    District="test", PostalCode="test", LocationTypeCode=1, Description="test", ShippingNotes="test",
                    CountriesCountryId=1)
