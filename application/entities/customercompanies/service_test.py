...
def test_get_all(db: SQLAlchemy):  # noqa
    yin: CustomerCompany = CustomerCompany(CompanyId=16, CompanyName="test16", CompanyCreditLimit="test16", CreditLimitCurrency="test16")
    yang: CustomerCompany = CustomerCompany(CompanyId=16, CompanyName="test16", CompanyCreditLimit="test16", CreditLimitCurrency="test16")
    db.session.add(yin)
    db.session.add(yang)
    db.session.commit()
