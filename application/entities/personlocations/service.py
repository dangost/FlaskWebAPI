...
class PersonLocationsService:
    ...
    def update(self, personlocation: PersonLocation,
               personlocation_change_updates: PersonLocationInterface) -> PersonLocation:
    ...
    def create(self, new_attrs: PersonLocationInterface) -> PersonLocation:
        new_personlocation = PersonLocation(PeoplePersonId=new_attrs["PeoplePersonId"],
                                            LocationsLocationsId=new_attrs["LocationsLocationsId"],
                                            SubAddress=new_attrs["SubAddress"],
                                            LocationUsage=new_attrs["LocationUsage"], Notes=new_attrs["Notes"])
